...
<div class="instruction"><span class="step-label">c</span> Verify in the Aura Query editor -- go to your instance, click <strong>Connect &rarr; Query</strong>, and run the verification query Claude Code provides.</div>
...
The workflow in one line: **define &rarr; import &rarr; query**, with the schema as ground truth the whole way through.
