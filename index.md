...
This post does that — live, in order, including the roadblocks. From a blank Zed window to a queryable Star Wars graph, using Claude Code running as a Terminal Thread alongside the project. No Cypher knowledge required.
